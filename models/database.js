...
module.exports = async () => {
  let client;
  const connectionUrl = process.env.NODE_ENV === 'development' ||  process.env.NODE_ENV === undefined  ? 'mongodb://localhost:27017/helps' : "mongodb+srv://vercel-admin-user:ETPIicfqVnzDNJNr@portfolio.s3wva9j.mongodb.net/helps?retryWrites=true&w=majority";
