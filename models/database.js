...
module.exports = async () => {
  let client;
  const connectionUrl = process.env.NODE_ENV === 'development' ? 'mongodb://localhost:27017/datr' : "mongodb+srv://vercel-admin-user:ETPIicfqVnzDNJNr@portfolio.s3wva9j.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
