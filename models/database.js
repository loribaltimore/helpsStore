...
module.exports = async () => {
  let client;
  const connectionUrl = process.env.NODE_ENV === 'development' ? 'mongodb://localhost:27017/datr' : "mongodb+srv://dmksoc:v7TjmD4FzSk9UAV9@portfolio.s3wva9j.mongodb.net/?retryWrites=true&w=majority";
